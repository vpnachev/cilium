...
#
FROM quay.io/cilium/cilium-envoy:9762f21fbd439d04a6ff1021ea9578b00961a68b as cilium-envoy
...
#
FROM quay.io/cilium/cilium-builder:2019-11-06-v1.6 as builder
...
#
FROM quay.io/cilium/cilium-runtime:2019-11-06-v1.6
LABEL maintainer="maintainer@cilium.io"
